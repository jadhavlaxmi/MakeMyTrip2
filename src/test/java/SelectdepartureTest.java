...
import java.net.URL;
public class SelectdepartureTest {
  ...
  public void selectdeparture() {
    ...
    driver.findElement(By.cssSelector(".DayPicker-Week:nth-child(1) > .DayPicker-Day--selected:nth-child(4) > .dateInnerCell")).click();
    
    System.out.println("done");
    driver.findElement(By.xpath("//div[contains(@class,'DayPicker') and contains(@aria-label,'Jun 12 2022')]")).click();
    System.out.println("done");
   
    {
      WebElement element = driver.findElement(By.cssSelector("li:nth-child(1) > .darkGreyText > .font12"));
